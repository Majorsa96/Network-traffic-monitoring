...
![DNS Capture](siphesihle/Screenshots/dns_capture.png)

### 6.2 HTTP CAPTURE
The following screenshot shows HTTP protocol distribution
![HTTP Capture](siphesihle/Screenshots/http_capture.png)

### 6.3 ICMP CAPTURE
The following screenshot shows ICMP protocol distribution
![ICMP Capture](siphesihle/Screenshots/icmp_capture.png)
